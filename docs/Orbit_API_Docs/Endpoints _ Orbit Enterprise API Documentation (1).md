...
The Verifier API base URL for the dev environment is:https://testapi-verifier.nborbit.ca

The Verifier API's Swagger link is:https://testapi-verifier.nborbit.ca/api/docs